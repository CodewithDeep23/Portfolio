...
export default function CardSection() {
 ...
 flex justify-center overflow-hidden bg-black/70 backdrop-blur-lg 
        ...
        >
          ...
          <div className="w-full flex flex-col">
            <div className="flex flex-col items-center gap-2">
              {card.icon}
              <p className="flex items-center justify-start flex-col text-[12px] font-bold gap-2 text-white">
                {card.title}
              </p>
            </div>
          </div>
